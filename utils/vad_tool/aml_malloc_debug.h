...
void* aml_audio_debug_malloc(size_t size, const char * file_name, size_t line);
void* aml_audio_debug_realloc(void* pointer, size_t bytes, const char * file_name, size_t line);
void* aml_audio_debug_calloc(size_t nmemb, size_t bytes, const char * file_name, size_t line);
void aml_audio_debug_free(void* pointer);
void aml_audio_debug_malloc_showinfo(size_t level);
